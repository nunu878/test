...
# 한글 폰트 설정
# plt.rcParams['font.family'] = "AppleGothic" # 이 줄은 그대로 두거나 주석 처리
# Windows, 리눅스 사용자
# plt.rcParams['font.family'] = "Malgun Gothic" # 이 줄을 주석 처리하거나 제거
plt.rcParams['font.family'] = "NanumGothic" # 이 줄을 새로 추가
